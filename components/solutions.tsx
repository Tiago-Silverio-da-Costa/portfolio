            ...
            <div className="mx-auto w-5/6 max-w-5xl">
                ...
                <div className=" flex flex-wrap gap-6 mt-8 justify-center items-stretch">
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-2 rounded-full bg-textTitle" src="/hero/landing.svg" alt="" width={100} height={100} />
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-2 rounded-full bg-textTitle" src="/hero/ecommerce.svg" alt="" width={100} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            Lojas Virtuais
                        </h2>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-2 rounded-full bg-textTitle" src="/hero/institutions.svg" alt="" width={100} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-2 rounded-full bg-textTitle" src="/hero/websystem.svg" alt="" width={100} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            Sistemas Web
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-3 rounded-full bg-textTitle" src="/hero/app.svg" alt="" width={80} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            App
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-3 rounded-full bg-textTitle" src="/hero/seo.svg" alt="" width={80} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            Estratégias de SEO
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                    ...
                    <div className="flex flex-col items-center  shadow-md rounded-md px-6 py-4 bg-white">
                        <Image className="px-4 py-3 rounded-full bg-textTitle" src="/hero/fix.svg" alt="" width={80} height={100} />
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            Suporte
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
