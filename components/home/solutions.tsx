        ...
        <section className="flex flex-col items-center justify-center py-32">
            <div className="mx-auto w-5/6 max-w-5xl">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-textTitle">
                    {texts.solutions?.title || "O que eu ofereço para o seu negócio"}
                </h1>
                <div className=" flex flex-wrap gap-6 mt-8 justify-center items-stretch">
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.landingPageTitle || "Landing Pages"}
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                            {texts.solutions?.landingPageDesc || "Converta visitantes em clientes potenciais de forma eficaz e direta."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.ecommerceTitle || "Lojas Virtuais"}
                        </h2>
                        <p className="text-center text-lg mt-2 max-w-60 leading-6 tracking-tighter">
                            {texts.solutions?.ecommerceDesc || "Dê vida aos seus produtos online, facilitando compras seguras e práticas para seus clientes."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.institutionalWebsitesTitle || "Sites Institucionais"}
                        </h2>
                        <p className="text-center text-lg mt-2 max-w-60 leading-6 tracking-tighter">
                            {texts.solutions?.institutionalWebsitesDesc || "Apresente sua empresa, produtos e serviços, além de fortalecer sua marca e conquistar novos clientes."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.webSystemsTitle || "Sistemas Web"}
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                            {texts.solutions?.webSystemsDesc || "Facilite suas operações, como vendas, gestão de clientes e controle de estoque, tudo integrado e seguro"}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.AppTitle || "Aplicativo"}
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                            {texts.solutions?.AppDesc || "Desenvolvemos aplicativos personalizados que conectam, engajam e transformam."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.seoTitle || "Estratégias de SEO"}
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                            {texts.solutions?.seoDesc || "Aumente a visibilidade do seu site e atraia mais tráfego qualificado."}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center  shadow-md rounded-md px-6 py-4 bg-white">
                        ...
                        <h2 className="font-semibold text-defaultText text-lg md:text-2xl tracking-wider">
                            {texts.solutions?.suportTitle || "Suporte"}
                        </h2>
                        <p className="text-center text-lg mt-2 leading-6 tracking-tighter max-w-60">
                            {texts.solutions?.suportDesc || "Garanta que seu site permaneça atualizado, seguro e funcional"}
                        </p>
                    </div>
                </div>
            </div>
