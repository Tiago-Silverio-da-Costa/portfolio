...
export default function Contact() {
    return (
        <motion.section
            ...
            id="contact"
            className="flex flex-col justify-center gap-4 py-20 lg:h-screen bg-white">
            <div className="mx-auto w-5/6 max-w-5xl">
                ...
                <main className="flex flex-col-reverse lg:flex-row items-start md:items-center  gap-4 justify-between text-defaultText">
                    <section className="flex flex-col">
                        ...
                        <Link className="flex items-center gap-2 text-sm font-bold bg-highlightElement text-bgFooter py-2 px-4 rounded-md w-fit mt-6"
                            target="_blank"
                            rel="noreferrer"
                    ...
                    <section className="flex flex-col justify-start items-center gap-6">
                        ...
                        <Image className="rounded-full" src="/contact/look.jpg" alt="Foto do Desenvolvedor Tiago S. C." width={386} height={386} />
